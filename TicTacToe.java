...
public class TicTacToe {
	...
	private int[][] board; // 2d array representing the tic-tac-toe board
	...
	private boolean checkWinDiag() {
		...
		boolean crossWin= (((this.getMark(0,0) == CROSS) && (this.getMark(1,1) == CROSS)
		&& (this.getMark(2,2) == CROSS)) || ((this.getMark(0,2) == CROSS)
				&& (this.getMark(1,1) == CROSS)
				&& (this.getMark(2,0) == CROSS)));
		boolean circleWin= (((this.getMark(0,0) == CIRCLE) && (this.getMark(1,1) == CIRCLE)
				&& (this.getMark(2,2)  == CIRCLE)) || ((this.getMark(0,2) == CIRCLE)
				&& (this.getMark(1,1) == CIRCLE)
				&& (this.getMark(2,0)== CIRCLE)));
		return circleWin || crossWin;
